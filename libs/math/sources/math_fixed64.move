...
module math::math_fixed64 {
    ...
    fun exp_raw(x: u256): u256 {
        ...
        assert!(shift_long <= 63, EOVERFLOW_EXP);
    ...
    #[test]
    fun test_fixed(){
        let foo = fixed_point64::create_from_rational(1,3);
        let bar = fixed_point64::multiply_u128((sui::math::pow(10,9) as u128), foo);
        std::debug::print(&bar);
