...
module math::math64 {
    use math::fixed_point32::{Self, FixedPoint32};

    /// Cannot log2 the value 0
    const EINVALID_ARGUMENTS: u64 = 2;
    ...
    #[test]
    #[expected_failure(abort_code = EINVALID_ARGUMENTS, location = math::math64)]
